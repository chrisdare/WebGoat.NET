...
namespace OWASP.WebGoat.NET.App_Code.DB
{
    public class MySqlDbProvider : IDbProvider
    {
        ...
        public bool RecreateGoatDb()
        {
            ...
            int retVal1 = Math.Abs(Util.RunProcessWithInput(_clientExec, args, HttpContext.Current.Server.MapPath(DbConstants.DB_CREATE_MYSQL_SCRIPT)));
            int retVal2 = Math.Abs(Util.RunProcessWithInput(_clientExec, args, HttpContext.Current.Server.MapPath(DbConstants.DB_LOAD_MYSQL_SCRIPT)));
